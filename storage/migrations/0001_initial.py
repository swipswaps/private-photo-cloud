# -*- coding: utf-8 -*-
# Generated by Django 1.10.3 on 2016-11-08 21:54
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('screenshot', models.ImageField(blank=True, height_field='screenshot_height', help_text='Image taken from the video', upload_to=storage.models.Media.generate_screenshot_filename, width_field='screenshot_width')),
                ('screenshot_width', models.IntegerField(blank=True, null=True)),
                ('screenshot_height', models.IntegerField(blank=True, null=True)),
